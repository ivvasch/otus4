...
import ru.otus4.repository.DataTemplateHibernate;
import ru.otus4.repository.HibernateUtils;
import ru.otus4.sessionmanager.TransactionManagerHibernate;
import ru.otus4.dbmigrations.MigrationsExecutorFlyway;
...
public class WebServerWithBasicSecurityDemo {
    ...
    private static final String HASH_LOGIN_SERVICE_CONFIG_NAME = "note.md";
