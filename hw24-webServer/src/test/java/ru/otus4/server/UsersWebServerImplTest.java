...
//import ru.otus4.dao.UserDao;
//import ru.otus4.model.User;
//import ru.otus4.services.TemplateProcessor;
//import ru.otus4.services.UserAuthService;
//import ru.otus4.server.utils.WebServerHelper;
//
//import java.net.*;
...
//                .uri(URI.create(WebServerHelper.buildUrl(WEB_SERVER_URL, API_USER_URL)))
//                .build();
...
//        HttpCookie jSessionIdCookie = WebServerHelper.login(WebServerHelper.buildUrl(WEB_SERVER_URL, LOGIN_URL), DEFAULT_USER_LOGIN, DEFAULT_USER_PASSWORD);
...
//        HttpCookie jSessionIdCookie = WebServerHelper.login(WebServerHelper.buildUrl(WEB_SERVER_URL, LOGIN_URL), INCORRECT_USER_LOGIN, DEFAULT_USER_PASSWORD);
...
//
//        HttpRequest request = HttpRequest.newBuilder().GET()
//                .uri(URI.create(WebServerHelper.buildUrl(WEB_SERVER_URL, API_USER_URL,String.valueOf(DEFAULT_USER_ID))))
//                .setHeader(WebServerHelper.COOKIE_HEADER, String.format("%s=%s", jSessionIdCookie.getName(), jSessionIdCookie.getValue()))
//                .build();
//        HttpResponse<String> response = http.send(request, HttpResponse.BodyHandlers.ofString());
//
